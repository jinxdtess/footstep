...
public class BallController {
    ...
    public String newBall(@RequestParam(value="winId")int winId,Model model){
    	Lottery lottery= ballService.findNew(winId);
    	model.addAttribute(lottery);
    	return "ball_view";
    }
  ...
  //生成图表的方法
    ...
    @RequestMapping("luck")
    @ResponseBody
    public String haveLuck(@RequestParam("maxrange")String maxrange,@RequestParam("disperse")String disperse,
    	...
    	List<Reds> good=ballService.selectCode(maxrange, disperse, partition, likeCode,parity,evenno,number,predrop);
